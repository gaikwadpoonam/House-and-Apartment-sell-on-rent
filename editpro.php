		...
		//declare variables who hold data from the form fields
			...
			if($imagepath){
				...
				echo $picture;
		 		...
		 		$update=mysqli_query($conn,"UPDATE puser SET username='$username',email='$email',image='$picture' WHERE id='$userid'");
		 	if($update){
		 		echo"good";
		 	...
		 	$update=mysqli_query($conn,"UPDATE puser SET username='$username',email='$email' WHERE id='$userid'");
		 	if($update){
		 		echo"good";
		 		echo "<script language='Javascript'>";
		 		echo "document.location.replace('./page.php')";
	...
	if(isset ($_POST['submit2'])){
		//declare variables who hold data from the form fields
			...
			if($password1==$password2){
				...
				$update=mysqli_query($conn,"UPDATE puser SET password='$password'");
		 	if($update){
		 		echo"good";
		 		echo "<script language='Javascript'>";
